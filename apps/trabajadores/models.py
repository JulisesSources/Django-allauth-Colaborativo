...
class Puesto(models.Model):
    """
    Modelo para los puestos de trabajo (Docente, Administrativo, etc.)
    """
    ...
    nivel = models.CharField(max_length=100, verbose_name="Nivel", 
                            help_text="Ej: Académico, Administrativo, Directivo")
...
class TipoNombramiento(models.Model):
    """
    Modelo para tipos de nombramiento (Base, Confianza, Interino, etc.)
    """
...
class Trabajador(models.Model):
    """
    Modelo principal para los trabajadores
    """
    ...
    # Foreign Keys (se conectarán cuando estén los modelos)
